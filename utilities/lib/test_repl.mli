(** [parse_argv argv] parses the command-line flags in [argv], and returns a
    pair containing the path to the specified REPL executable, and the path to
    the directory of test cases. *)

...
(**
  [bind ~recf:() id value body] constructs the binding of [id] to
  [value] within [body].  If the [recf] argument is passed, then [id] is
  in scope in [value] as well as [body].  Note that [value] is not
  generalized--it is monomorphic!
 *)
